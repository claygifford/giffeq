  ...
  return (
    <div className="flex-1 p-4 overflow-y-auto">
      ...
      <Link href="/api/spotify/login" passHref legacyBehavior>
        <a className="group relative flex w-full justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
          Login with Spotify
        </a>
      </Link>
    </div>
